...
module.exports = {
  async up(queryInterface) {
    ...
    const newKeys = ['hris.document.manage'];
  ...
  async down(queryInterface) {
    await queryInterface.sequelize.query(
      `DELETE FROM "RolePermissions" WHERE "permissionKey" = 'hris.document.manage'`
    );
    await queryInterface.sequelize.query(
      `DELETE FROM "Permissions" WHERE key = 'hris.document.manage'`
    );
  },
};
