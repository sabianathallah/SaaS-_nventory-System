...
module.exports = {
  async up(queryInterface) {
    ...
    const newKeys = ['hris.payslip.manage'];
  ...
  async down(queryInterface) {
    await queryInterface.sequelize.query(
      `DELETE FROM "RolePermissions" WHERE "permissionKey" = 'hris.payslip.manage'`
    );
    await queryInterface.sequelize.query(
      `DELETE FROM "Permissions" WHERE key = 'hris.payslip.manage'`
    );
  },
};
