...
module.exports = (sequelize, DataTypes) => {
  class Stock_In_Draft_Item extends Model {
    static associate(models) {
      Stock_In_Draft_Item.belongsTo(models.Stock_In_Draft, {
        foreignKey: { name: 'DraftId', allowNull: false },
        onDelete: 'CASCADE',
        onUpdate: 'CASCADE',
      });
      Stock_In_Draft_Item.belongsTo(models.ProductSKU, {
  ...
  }, { sequelize, modelName: 'Stock_In_Draft_Item' });
  return Stock_In_Draft_Item;
};
